...
export default function Home() {
  return (
    <>
          ...
          <div className="flex-1">
            ...
            <div className="ml-10 mt-8">
              ...
              <span className="w-full left-[36.01px] top-[404px] text-neutral-500 text-[16px] font-normal leading-7">
                questions, automate via chatbots, and escalate to your agents
                when it makes sense.
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-row">
          <div className="flex-1">
            ...
            <div className="w-full text-neutral-500 text-[16px] font-normal leading-normal">
              ...
              your web page or use special plugins provided by Social Intents
              for platforms like Shopify, WordPress, Bigcommerce, or Wix.
            </div>
          </div>
          <div className="hidden md:flex md:flex-1">
      ...
      <div className="flex flex-col p-7  bg-gradient-to-r from-blue-600 to-zinc-800 justify-center items-center">
        <div className="md:w-[80%] w-full h-[1px] bg-white m-3"></div>
        <div className="flex flex-col md:flex-row w-full md:w-[80%]">
          <div className="w-full text-white text-xs font-normal leading-tight">
            © Social Intents, LLC. All rights reserved.
          </div>
